    ...
    <div id="rev_slider_1075_2" class="rev_slider fullscreen" style="display:none;" data-version="5.4.1">
        <ul>
            ...
            <li data-index="rs-3035" data-transition="fade" data-slotamount="7" data-hideafterloop="0"
                ...
                <!-- LAYERS NR. 2 -->
                <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme" id="slide-5-layer-4" data-x="954"
                    data-y="400" data-width="['40']" data-height="['1']" data-type="shape"
                ...
                <!-- LAYER NR. 3 -->
                <div class="tp-caption   tp-resizeme" id="slide-3034-layer-22" data-x="1053" data-y="300"
...
{{-- "https://www.sampannee.com/images/index3.jpg" --}}
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="welcome-right padding-left-125">
                    ...
                    <h6 class="small-headline">“Experience authentic Thai cuisine in the heart of Dupont Circle, D.C.
                        at
                        our restaurant, where we serve visually stunning dishes that tantalize the taste buds. ”.</h6>
                    <p>At Sampannee, we take great pride in our Thai heritage. Our culinary journey began in the royal
                        Thai palace, where we honed our skills to serve the esteemed royal family. Today, we are excited
                        to bring the rich flavors of Thai cuisine to the United States. Indulge in our delectable Thai
                        dishes and savor the exotic drinks that will leave a lasting impression on your palate. Join us
                        as we embark on this culinary adventure together!</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="menu-inner-left padding-right-90">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <p class="gray">We are delighted to offer you the true essence of Thai cuisine,
                                    served
                                    with a touch of modern elegance. At our restaurant, you'll find a harmonious blend
                                    of authentic flavors and contemporary decor, creating a unique dining experience.
                                </p>
                            </div>
                            <div class="col-sm-6 col-md-6">
                                <p class="gray">Whether you're seeking a hearty brunch, happy hour delights, or an
                                    extensive dine-in menu, we have you covered. And if you prefer the comfort of your
                                    own home, we provide convenient online ordering and delivery services. Don't let
                                    your cravings for Thai food go unsatisfied!</p>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="specialties-right padding-left-125 padding-top-65">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-md-6">
                            <p>Indulge in a delightful selection of beverages at Sampannee! Our extensive drink menu is
                                designed to complement your dining experience perfectly. </p>
                        </div>
                        <div class="col-sm-6 col-md-6">
                            <p>Whether you're in the mood for a classic favorite, a special creation unique to
                                Sampannee, or a refreshing mocktail, we have something to satisfy every palate.</p>
                        </div>
                    </div>
        ...
        <div class="col-sm-12 col-md-6">
            <div class="reservation-block padding-right-155 padding-left-155 display-flex vertical-center">
                <div class="reservation-detail flx-align-self">
                    ...
                    <p class="black">Planning a memorable celebration? Look no further! Our restaurant offers the
                        perfect setting to commemorate your joyous occasion. Reserve your table today, and let us create
                        an extraordinary dining experience filled with delectable dishes and warm hospitality.
